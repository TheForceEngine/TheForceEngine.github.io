...
Notice that we compute |dx| and |dz| (where dx = x1 - x0 and dz = z1 - z0) and use the larger value as the denominator in the slope. How does that help us? Let's assume that |dx| > |dz|:
